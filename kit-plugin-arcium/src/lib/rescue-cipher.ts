// @ts-nocheck
/**
 * Crypto primitives extracted from @arcium-hq/client v0.8.5
 * Source: node_modules/@arcium-hq/client/build/index.mjs
 *
 * Includes: RescueCipher, CSplRescueCipher, RescuePrimeHash, arcisEd25519,
 * AesCtrCipher, Aes128/192/256Cipher, and related math primitives.
 *
 * Extracted to eliminate the dependency on @arcium-hq/client which depends
 * on @coral-xyz/anchor and @solana/web3.js v1.
 *
...
// randomBytes$1 was @noble/hashes/utils randomBytes; Node.js crypto's randomBytes is compatible
...
export {
  ...
  Matrix,
  RescueDesc,
  encodeAsRescueEncryptable,
  decodeRescueDecryptedToBigInt,
  decodeRescueDecryptedToNumber,
