...
export const MULTISIG_SET_RENT_COLLECTOR_DISCRIMINATOR = new Uint8Array([
  48, 204, 65, 57, 210, 70, 156, 74,
]);

export function getMultisigSetRentCollectorDiscriminatorBytes() {
...
> = {
  ...
  rentCollector: MultisigSetRentCollectorInstructionDataArgs["rentCollector"];
  memo: MultisigSetRentCollectorInstructionDataArgs["memo"];
};
